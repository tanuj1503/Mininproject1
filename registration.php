...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
        $sql = "INSERT INTO users (firstname,lastname,username,password,birthdate,gender,phone,email,address,helper,token) VALUES(?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = mysqli_prepare($connection, $sql);
        if($stmt)
        {
            mysqli_stmt_bind_param($stmt, "sssssssssss",$param_firstName, $param_lastName, $param_username, $param_password, $param_birthdate, $param_gender, $param_phone, $param_email, $param_address, $param_select,$param_token);
